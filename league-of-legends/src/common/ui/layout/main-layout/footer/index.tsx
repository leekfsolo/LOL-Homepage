    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.footer__logo}>
        <svg
          ...
          fill={isLogoHover ? "#f9f9f9" : "#737373"}
      ...
      <div className={styles.footer__copyright}>
        <p>
          ™ & © 2022 Riot Games, Inc. League of Legends and all related logos,
      ...
      <div className={styles.footer__rating}>
        <div className={styles.rating__img}>
          <img
            src="https://res.cloudinary.com/dcsi3yllr/image/upload/v1650417618/Decoration/na-esrb_cmnhjy.png"
            alt=""
          />
        </div>
